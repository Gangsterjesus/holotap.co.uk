...
// ────────────────────────────────────────────────────────────────────────────────
const ACTOR_PRECEDENCE = ['founder', 'session', 'qr', 'anonymous'];
// ────────────────────────────────────────────────────────────────────────────────
...
// ────────────────────────────────────────────────────────────────────────────────
function resolveFounderActor(founder) {
    return {
        type: 'founder',
        role: 'superuser',
        issuedAt: Date.now(),
...
// ────────────────────────────────────────────────────────────────────────────────
function resolveAnonymousActor() {
    return {
        type: 'anonymous',
        role: null,
        issuedAt: Date.now(),
